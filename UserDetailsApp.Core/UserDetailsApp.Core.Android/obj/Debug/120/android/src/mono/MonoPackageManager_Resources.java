...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "UserDetailsApp.Core.Android.dll" comes first in this list. */
		"UserDetailsApp.Core.Android.dll",
		"UserDetailsApp.Contracts.dll",
		"UserDetailsApp.Models.dll",
		"UserDetailsApp.Implementations.dll",
		"Acr.UserDialogs.dll",
		"AndHUD.dll",
		"Autofac.dll",
